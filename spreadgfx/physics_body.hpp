...
SPREAD_API float physicsBody_GetVelocityX(physics_body body);
SPREAD_API float physicsBody_GetVelocityY(physics_body body);

SPREAD_API void physicsBody_SetPosition(physics_body body, b2Vec2 pos);

SPREAD_API void physicsBody_ApplyImpulse(physics_body body, b2Vec2 impulse);